interface IAccountIconProps {
  classNameAccountIcon: string;
}

const AccountIcon = ({ classNameAccountIcon }: IAccountIconProps): JSX.Element => {
  return (
    <div className={classNameAccountIcon}>
      <svg
        version="1.0"
      ...
      >
        ...
        >
          <path
            d="M6005 12474 c-22 -2 -89 -9 -149 -14 -542 -53 -1087 -253 -1556 -571
      ...
      1435 -92 11 -518 21 -590 14z"
          />
          <path
            d="M8585 5886 c-478 -363 -1085 -626 -1687 -730 -247 -43 -348 -51 -678
